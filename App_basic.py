...
class App(tk.Tk):
    def __init__(self):
        ...
        self.entry = tk.Label(self.frame2,width=38,anchor='center',text='hrhtgrhtghthththththththt',bg='red',fg='white')
        ...
        expression=create_buttons(2,13,self.frame3,self.entry)
